...
# feces
lower_feces <- as.character(roughset$lower.approximation$Feces)
upper_feces <- as.character(roughset$upper.approximation$Feces) 

# skin 
lower_skin <- as.character(roughset$lower.approximation$Skin)
upper_skin <- as.character(roughset$upper.approximation$Skin)
